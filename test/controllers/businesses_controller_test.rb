...
class BusinessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create business' do
    assert_difference('Business.count') do
      post businesses_url, params: { business: { description: @business.description, name: @business.name } }
    end
  ...
  test 'should update business' do
    patch business_url(@business), params: { business: { description: @business.description, name: @business.name } }
